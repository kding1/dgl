...
if __name__ == '__main__':
    ...
    parser.add_argument("--bn", default=False,
                        action='store_true')    
    parser.add_argument("--dist-inf", default=False,
                        action='store_true')    
    ...
    if args.dataset == 'reddit':
        part_config = os.path.join(part_config, "Libra_result_reddit",\
                                   str(nc) + "Communities", "reddit.json")
    elif args.dataset == 'cora':
        part_config = os.path.join(part_config, "Libra_result_cora",\
                                   str(nc) + "Communities", "cora.json")
    elif args.dataset == 'citeseer':
        part_config = os.path.join(part_config, "Libra_result_citeseer",\
                                   str(nc) + "Communities", "citeseer.json")
